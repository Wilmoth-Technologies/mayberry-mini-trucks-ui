                ...
                <div>
                    <div className="inline-flex items-center">
                        <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" className={"w-4 h-4 cursor-pointer " + (props.rating > 0.1 ? "text-orange-400" : "text-blue-gray-500")}>
                        ...
                        <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                            className="w-4 h-4 text-blue-gray-500 cursor-pointer">
