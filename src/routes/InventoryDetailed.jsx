        ...
        <>
            ...
            <div className="grid p-3 gap-3 md:grid-cols-2">
                ...
                <div className="hidden md:grid md:grid-cols-2 md:gap-x-8">
                    ...
                    <h2 className="text-2xl font-semibold text-action-yellow col-span-2 text-center pb-8">{numberFormatter(CURRENCY_FORMAT_STYLE, 2).format(inventoryData.price)}</h2>
